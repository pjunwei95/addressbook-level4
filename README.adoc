...
https://coveralls.io/github/CS2103AUG2017-W13-B2/main?branch=master[image:https://coveralls.io/repos/github/CS2103AUG2017-W13-B2/main/badge.svg?branch=master[Coverage Status]]
