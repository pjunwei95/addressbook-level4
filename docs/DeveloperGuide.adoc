...
** FORMAT - `nusmods [INDEX]`

e.g. - `nusmods 1`

==== Working flow

The `nusmodsParser` class parses the arguments and throws an exception if the index entered
is invalid. A new event `handleNusmodsEvent`  is then raised.
The Brower Panel class then loads the page with the url of the profile page to be displayed. +
