...
The result display panel will show whether the command is valid while you are typing.
Also, the message displayed will tell you exactly which part goes wrong.

image::valid.png[width="720"]

image::pink.png[width="850"]

image::invalid.png[width="790"]
// end::parse[]
