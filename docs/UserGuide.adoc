...
This feature helps you view the profile page of a person in your contact list. This way we can know more about our friends +
and colleagues. +
...
** Result ** +
The facebook homepgae shows up on the browser panel. +
