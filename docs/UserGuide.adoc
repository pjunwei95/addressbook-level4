...
* The content of remark should be in the format MODNAME/MODTYPE/GROUPNUM.
...
// tag::nusmods[]
=== List out a person's module information

On click of a person's panel, this person's module lists will be list out in the panel.

****
* The nusmods information here displays according to the information in the remark field.
* All info shuold coexist in nusmods. This app dont check the validity of the module information.
****
...
User can also logout using the logout command.
// end::loginlogout[]
